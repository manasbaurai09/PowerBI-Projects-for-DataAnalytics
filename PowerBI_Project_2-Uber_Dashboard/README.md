...
The design uses a sleek black-and-white aesthetic with Uber branding, and leverages a calendar table, DAX time intelligence, field parameters, and custom image integration for a polished, portfolio-ready output. The Dataset used in this:- [Uber Data](Uber_Dataset)
